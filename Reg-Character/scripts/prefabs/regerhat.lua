local assets = {Asset("ANIM", "anim/hat_regerhat.zip"), Asset("ATLAS", "images/inventoryimages/regerhat.xml")}
...
STRINGS.NAMES.REGERHAT = "Reg Hat"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.REGERHAT = "Here I come, the bottom of Naraku."
return Prefab("regerhat", fn, assets)
