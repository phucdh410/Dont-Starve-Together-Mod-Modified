...
local states=
{
    ...
    State{
        ...
        State{
        name = "abused_positive",
        tags = {"canrotate"},

        onenter = function(inst)
            inst.components.locomotor:StopMoving()
            inst.AnimState:PlayAnimation("whipped_positive")
            inst.SoundEmitter:PlaySound("babybeefalo/creature/baby_abused")
        end,
        ...
        State{
        name = "abused_negative",
        tags = {"canrotate"},

        onenter = function(inst)
            inst.components.locomotor:StopMoving()
            inst.AnimState:PlayAnimation("whipped_negative")
--            inst.SoundEmitter:PlaySound("babybeefalo/creature/positive")
        end,
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(6*FRAMES, function(inst) inst.SoundEmitter:PlaySound("koalebeef/creature/beg") end),
        },
    ...
    State{
        ...
        timeline =
        {
            TimeEvent(28*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/creatures/koalefant/chew") end),
            TimeEvent(56*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/creatures/koalefant/chew") end),
            TimeEvent(84*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/creatures/koalefant/chew") end),
            TimeEvent(112*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/creatures/koalefant/chew") end),
        },
...
return StateGraph("koalebeef", states, events, "idle", actionhandlers)
