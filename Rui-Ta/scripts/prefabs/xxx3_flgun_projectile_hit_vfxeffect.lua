...
local COLOUR_ENVELOPE_NAME_SMOKE = "xxx3_flgun_projectile_hit_vfxeffect_colourenvelope_smoke"
local SCALE_ENVELOPE_NAME_SMOKE = "xxx3_flgun_projectile_hit_vfxeffect_scaleenvelope_smoke"
local COLOUR_ENVELOPE_NAME_EMBER = "xxx3_flgun_projectile_hit_vfxeffect_colourenvelope_ember"
local SCALE_ENVELOPE_NAME_EMBER = "xxx3_flgun_projectile_hit_vfxeffect_scaleenvelope_ember"
local COLOUR_ENVELOPE_NAME_CIRCLE = "xxx3_flgun_projectile_hit_vfxeffect_colourenvelope_circle"
local SCALE_ENVELOPE_NAME_CIRCLE = "xxx3_flgun_projectile_hit_vfxeffect_scaleenvelope_circle"
local COLOUR_ENVELOPE_NAME_SMOKE2 = "xxx3_flgun_projectile_hit_vfxeffect_colourenvelope_smoke2"
local SCALE_ENVELOPE_NAME_SMOKE2 = "xxx3_flgun_projectile_hit_vfxeffect_scaleenvelope_smoke2"
local COLOUR_ENVELOPE_NAME_ARROW = "xxx3_flgun_projectile_hit_vfxeffect_colourenvelope_arrow"
local SCALE_ENVELOPE_NAME_ARROW = "xxx3_flgun_projectile_hit_vfxeffect_scaleenvelope_arrow"
...
return Prefab("xxx3_flgun_projectile_hit_vfxeffect", fn, assets)
