local assets =
{
    Asset("ANIM", "anim/xxx3_eyeplant_4.zip"),
...
local function fn()
	...
	inst.Light:SetColour(140/255,251/255,251/255)
    ...
    inst.AnimState:SetBank("xxx3_eyeplant_4")
    inst.AnimState:SetBuild("xxx3_eyeplant_4")
    ...
    inst:SetStateGraph("SGxxx3_eyeplant_4")
...
return Prefab("xxx3_eyeplant_4", fn, assets)