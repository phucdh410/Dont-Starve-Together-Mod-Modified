ControlXxx3Minions = Class(BehaviourNode, function(self, inst)
    BehaviourNode._ctor(self, "ControlXxx3Minions")
    self.inst = inst
    self.ms = inst.components.xxx3_minionspawner
    self.radius = nil
    self.minionrange = 3.5
end)

function ControlXxx3Minions:GetClosestMinion(item, minions)
...
function ControlXxx3Minions:Visit()
    self.ms = self.inst.components.xxx3_minionspawner
