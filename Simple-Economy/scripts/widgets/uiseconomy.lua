...
local uiseconomy =
    ...
    function(self, owner)
        ...
        self.mainui.status.bg =
            self.mainui.status:AddChild(
            Image("images/sehud/status_" .. TUNING.SElan .. ".xml", "status_" .. TUNING.SElan .. ".tex")
        )
        ...
        for i = 1, 8 do
            self.mainui.status.coinamount.num[i] =
                self.mainui.status.coinamount:AddChild(Image("images/sehud/bignums/0.xml", "0.tex"))
        ...
        for i = 1, 5 do
            self.mainui.status.level[i] =
                self.mainui.status:AddChild(Image("images/sehud/level_dact.xml", "level_dact.tex"))
        ...
        self.mainui.status.swdjinfo =
            self.mainui.status:AddChild(
            Image("images/sehud/swdj_" .. TUNING.SElan .. "1.xml", "swdj_" .. TUNING.SElan .. "1.tex")
        )
        ...
        self.mainui.status.expact:SetPosition(
            ...
            self.mainui.status.exp:GetPosition().y,
            0
        )
        ...
        self.mainbutton.coinamount.icon =
            self.mainbutton.coinamount:AddChild(Image("images/sehud/hudcoin.xml", "hudcoin.tex"))
        ...
        for i = 1, 8 do
            self.mainbutton.coinamount.num[i] =
                self.mainbutton.coinamount:AddChild(Image("images/sehud/bignums/0.xml", "0.tex"))
        ...
        self.owner:DoPeriodicTask(
            .25,
            function()
                if self.mainbuttonnewmove == true then
                    self.mainbutton.new:MoveTo(
                        Vector3(15, self.mainbutton.new.middle - 2, 0),
                        Vector3(15, self.mainbutton.new.middle + 2, 0),
                        .25
                    )
        ...
        self.mainui.buttonfood =
            self.mainui:AddChild(
            ImageButton("images/sehud/food_act_" .. TUNING.SElan .. ".xml", "food_act_" .. TUNING.SElan .. ".tex")
        )
        ...
        self.mainui.buttonfood:SetOnGainFocus(
            function()
                self.mainui.buttonfood:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.buttonfood:SetOnLoseFocus(
            function()
                self.mainui.buttonfood:ScaleTo(1.15, 1, .25)
            end
        )
        self.mainui.buttonfood:SetOnClick(
            function()
                self.numpage = 1
        ...
        self.mainui.buttoncloth =
            self.mainui:AddChild(
            ImageButton("images/sehud/cloth_dact_" .. TUNING.SElan .. ".xml", "cloth_dact_" .. TUNING.SElan .. ".tex")
        )
        ...
        self.mainui.buttoncloth:SetOnGainFocus(
            function()
                self.mainui.buttoncloth:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.buttoncloth:SetOnLoseFocus(
            function()
                self.mainui.buttoncloth:ScaleTo(1.15, 1, .25)
            end
        )
        self.mainui.buttoncloth:SetOnClick(
            function()
                self.numpage = 1
        ...
        self.mainui.buttonsmithing:SetOnGainFocus(
            function()
                self.mainui.buttonsmithing:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.buttonsmithing:SetOnLoseFocus(
            function()
                self.mainui.buttonsmithing:ScaleTo(1.15, 1, .25)
            end
        )
        ...
        self.mainui.buttonresource:SetOnGainFocus(
            function()
                self.mainui.buttonresource:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.buttonresource:SetOnLoseFocus(
            function()
                self.mainui.buttonresource:ScaleTo(1.15, 1, .25)
            end
        )
        ...
        self.mainui.buttonprecious:SetOnGainFocus(
            function()
                self.mainui.buttonprecious:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.buttonprecious:SetOnLoseFocus(
            function()
                self.mainui.buttonprecious:ScaleTo(1.15, 1, .25)
            end
        )
        ...
        self.mainui.refresh = self.mainui:AddChild(ImageButton("images/sehud/refresh.xml", "refresh.tex"))
        ...
        self.mainui.refresh:SetOnGainFocus(
            function()
                self.mainui.refresh:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.refresh:SetOnLoseFocus(
            function()
                self.mainui.refresh:ScaleTo(1.15, 1, .25)
            end
        )
        self.mainui.refresh:Hide()
        self.mainui.refresh:SetOnClick(
            function()
                self:onrefresh()
            end
        )

        self.mainui.infopage =
            self.mainui:AddChild(
            Image("images/sehud/infopage_" .. TUNING.SElan .. ".xml", "infopage_" .. TUNING.SElan .. ".tex")
        )
        ...
        self.mainui.close:SetOnGainFocus(
            function()
                self.mainui.close:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.close:SetOnLoseFocus(
            function()
                self.mainui.close:ScaleTo(1.15, 1, .25)
            end
        )
        self.mainui.close:SetOnClick(
            function()
                self:onclose()
            end
        )
        ...
        self.mainui.infobutton:SetOnGainFocus(
            function()
                self.mainui.infobutton:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.infobutton:SetOnLoseFocus(
            function()
                self.mainui.infobutton:ScaleTo(1.15, 1, .25)
            end
        )
        self.mainui.infobutton:SetOnClick(
            function()
        ...
        self.mainui.next:SetOnGainFocus(
            function()
                self.mainui.next:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.next:SetOnLoseFocus(
            function()
                self.mainui.next:ScaleTo(1.15, 1, .25)
            end
        )
        self.mainui.next:SetOnClick(
            function()
        ...
        self.mainui.back:SetOnGainFocus(
            function()
                self.mainui.back:ScaleTo(1, 1.15, .125)
            end
        )
        self.mainui.back:SetOnLoseFocus(
            function()
                self.mainui.back:ScaleTo(1.15, 1, .25)
            end
        )
        self.mainui.back:SetOnClick(
            function()
...
function uiseconomy:OnUpdate(dt)
    ...
    if self.level ~= self.owner.seclevel:value() then
        ...
        self.mainui.status.swdjinfo:SetTexture(
            "images/sehud/swdj_" .. TUNING.SElan .. self.owner.seclevel:value() .. ".xml",
        ...
        self.mainui.status.vipinfo:SetTexture(
            "images/sehud/vip" .. (self.owner.seclevel:value()) .. ".xml",
...
function uiseconomy:buildlist(title)
    ...
    if title == "food" then
        list = TUNING.tabc and TUNING.tabc[1] or TUNING.selist_food
    end
    if title == "cloth" then
        list = TUNING.tabc and TUNING.tabc[2] or TUNING.selist_cloth
    end
    if title == "smithing" then
        list = TUNING.tabc and TUNING.tabc[3] or TUNING.selist_smithing
    end
    if title == "resource" then
        list = TUNING.tabc and TUNING.tabc[4] or TUNING.selist_resource
    end
    ...
    for i = 1 + 48 * (self.numpage - 1), math.min(#list, 48 * (1 + self.numpage - 1)) do
        ...
        self.listslot[i] =
            self.mainui.goodslist:AddChild(ImageButton("images/sehud/slotbg_normal.xml", "slotbg_normal.tex"))
        ...
        self.listslot[i]:SetOnGainFocus(
            function()
                self.listslot[i]:ScaleTo(1, 1.15, .125)
            end
        )
        self.listslot[i]:SetOnLoseFocus(
            function()
        ...
        if pcall(resolvefilepath, atlas) then
            _atl = atlas
        else
        ...
        local positions = {-29, -21, -13, -5, 3, 11, 19, 27}
        local scale = {1.15, 1.15, 1}

        for j = 1, #positions do
            self.listslot[i]["num" .. j] = self.listslot[i]:AddChild(Image("images/sehud/numbers/0.xml", "0.tex"))
            self.listslot[i]["num" .. j]:SetPosition(positions[j], -33, 0)
            self.listslot[i]["num" .. j]:SetScale(unpack(scale))
        end
...
function uiseconomy:spitembuild(distance)
    ...
    for i = 1, #list do
        ...
        self.spitemslot[i] =
            self.mainui.status.specialitem:AddChild(
            ImageButton("images/sehud/slotbg_special.xml", "slotbg_special.tex")
        )
        ...
        self.spitemslot[i]:SetOnGainFocus(
            function()
                self.spitemslot[i]:ScaleTo(1, 1.15, .125)
            end
        )
        self.spitemslot[i]:SetOnLoseFocus(
            function()
                self.spitemslot[i]:ScaleTo(1.15, 1, .25)
            end
        )

        self.spitemslot[i].im =
            self.spitemslot[i]:AddChild(
            Image("images/inventoryimages/" .. list[i].name .. ".xml", list[i].name .. ".tex")
        )
        ...
        for j = 1, #positions do
            ...
            self.spitemslot[i]["num" .. j]:SetPosition(positions[j], -33, 0)
            self.spitemslot[i]["num" .. j]:SetScale(unpack(scale))
        end
...
function uiseconomy:buildbutton(title)
    ...
    self.mainui.buttoncloth:SetTextures(
        "images/sehud/cloth_dact_" .. TUNING.SElan .. ".xml",
