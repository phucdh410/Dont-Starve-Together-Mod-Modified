name = "G10MM-3R - DHPModified"
description = "My custom modified receipe statue for easier"
...
configuration_options = {
	{
		...
		options =
		{
			{description = "Easy", hover = "3 Gears + 5 Golds + 2 Electrical Doodads", data = 1},
			{description = "Normal", hover = "3 Red Gems + 3 Blue Gems + 3 Purple Gems", data = 2},
